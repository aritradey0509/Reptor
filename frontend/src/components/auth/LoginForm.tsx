  ...
  return (
    <Card className="w-full max-w-md p-8 space-y-6">
      <div className="text-center space-y-2">
        ...
        <h2 className="text-2xl font-extrabold text-white tracking-tight">Welcome Back to Reptor</h2>
        <p className="text-xs text-slate-400">Sign in to access your workout history and analytics</p>
      </div>
